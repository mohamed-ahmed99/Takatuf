...
function AuthNavbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 h-[72px] bg-white/95 backdrop-blur-xl border-b border-border z-50 shadow-sm shadow-black/4">
      <div className="max-w-[1200px] mx-auto px-6 h-full flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2.5 group">
          ...
          />
          <span className="text-2xl font-black text-primary tracking-tight">تكاتف</span>
        </Link>

        {/* Mobile toggle */}
        <button
          className="lg:hidden p-2 text-primary hover:bg-primary/8 rounded-xl transition-colors"
