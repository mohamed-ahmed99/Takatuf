  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="flex items-center justify-between text-sm">
        ...
        <a href="#" className="text-secondary font-medium hover:text-secondary-dark transition-colors">نسيت كلمة المرور؟</a>
      </div>
      <Button type="submit" variant="primary" size="lg" loading={loading} className="w-full">تسجيل الدخول</Button>
    </form>
  )
}

export default CharityLoginForm
